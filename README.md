...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/ShadabS05/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 8m12.823s                 | 1m8.624s                  | 
| `pg_normalized_batch`  | 2m24.425s                 | 0m17.933s                 | 
| `pg_denormalized`      | 0m21.327s                 | 0m3.426s                  | 
